...
rest_genes <- setdiff(renal_genes, unique(links$geneID))
...
svg("renal_circosplot.svg", width = 25, height = 25)
circos.clear()
chordDiagram(links,
             directional = 1,
             order = all_sectors,
...
tiff(filename = "circosplot_renal.tif",width = 12000,height = 12000,
     compression = "lzw",
     res = 600)
circos.clear()
chordDiagram(links,
